...
def main():
    ...
    (n, avg, min, max, hist) = (0, 0, 99999999999, 0, {})
    ...
    while True:
      try:
          ...
          if elap > 250: logging.warning(f'key={k} elap={elap}us')
          if (n%10000)==0:
            #logging.info(f Min/Avg/Max us | 'Min(us): {min:3.1f} | Avg (us): {avg/n:3.1f} | Max(us): {max:3.1f}')
